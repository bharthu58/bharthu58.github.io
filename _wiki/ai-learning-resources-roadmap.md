...
**Andrej Karpathy:**
- [Deep Dive into LLMs like ChatGPT](https://www.youtube.com/watch?v=7xTGNNLPyMI) — under-the-hood LLM fundamentals
- [How I use LLMs](https://www.youtube.com/watch?v=EWvNQjAaOHw) — practical usage examples
- [Intro to Large Language Models](https://www.youtube.com/watch?v=zjkBMFhNj_g) — foundational overview
